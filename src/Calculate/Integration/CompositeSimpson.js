    ...
    render() {
        return (
            <div style={{ background: " #6b7b8c ", padding: "30px", borderRadius:'2%'}}>
                <h3 style={{ fontFamily:'ui-serif',color: "black", fontWeight: "bold" }}>Composite Simpson's Rule</h3>
                <h5 style={{fontFamily:'ui-serif'}}>Simpson's rule is one of the numerical methods which is used to evaluate the definite integral. Usually, to find the definite integral</h5>
