    ...
    render() {
        return (
            <div style={{background: " #6b7b8c ", padding: "30px", borderRadius:'2%' }}>
                <h3 style={{ fontFamily:'ui-serif',color: "black", fontWeight: "bold" }}>Newton's Divided Differences Interpolation</h3>
                <h5 style={{fontFamily:'ui-serif'}}>Newton's Divided Difference Formula. where f [x0, x1] is the first divided difference of f relative to x0 and x1. So whenever f(x) is approximated with a second degree polynomial, the value of f(x) at any point x can be computed using the above polynomial.</h5>
                <div className="row">
                    <div className="col">
                        <Card
                            bordered={true}
