    ...
    render() {
        return(
            <div style={{background: " #6b7b8c ", padding: "30px", borderRadius:'2%' }}>
                <h3 style={{color: "black", fontWeight: "bold",fontFamily:'ui-serif'}}>Lagrange Interpolation</h3>
             <h5 style={{fontFamily:'ui-serif'}}>The Lagrange interpolation formula is a way to find a polynomial which takes on certain values at arbitrary points.</h5>
                <div className="row">
                    <div className="col">
                        <Card
                        bordered={true}
                    ...
                    <div className="col">
                        {this.state.showOutputCard &&
                            ...
                            title={"Output"}
                            bordered={true}
                            style={{ border: "2px solid black", background: "#e89a3c ", color: "white" }}
                            >
