...
class Euler extends Component {
    ...
    render() {
        return(
            <div style={{fontFamily:'ui-serif',background: " #6b7b8c ", padding: "30px", borderRadius:'2%' }}>
                <h3 style={{fontFamily:'ui-serif',color: "black", fontWeight: "bold"}}>Euler's Method</h3>
                <div className="row">
                    <div className="col">
                        <Card
                        bordered={true}
                ...
                {this.state.showOutputCard && 
                        ...
                        title={"Output"}
                        bordered={true}
                        style={{background: "#e89a3c", color: "#FFFFFFFF"}}
                        id="outputCard"
                        >
